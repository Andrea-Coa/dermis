...
#prueba como main
#problema con el analisis de más de un condition
con = "dark_spot"
_,output_prods = get_ingredients_and_products_for_condition(graph,con )

print("Productos utilizados para ", con, ": ", output_prods)